...
function init() {
  ...
  // Mode registrations — the hub owns these until their module is extracted
  // (traps → PR-C moves these calls into its own initTraps(api)); setup.js
  // and repertoire.js already register their own inside initX.
  ...
  // Load traps browse data (non-blocking — the section degrades gracefully;
  // repertoire browse data is loaded by initRepertoire).
  loadTraps();
}
